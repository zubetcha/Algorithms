...
function solution(record) {
  ...
  record.forEach((el) => {
    if (el.split(' ').length === 3) {
      ...
      recordByUid[uid] = recordByUid[uid] !== undefined ? [...recordByUid[uid], behavior + ' ' + nickname] : [behavior + ' ' + nickname]
      // { uid1234: [ 'Enter Muzi', 'Enter Prodo' ], uid4567: [ 'Enter Prodo', 'Change Ryan' ] }
    }
  })
...
// if 'Enter', 마지막 닉네임 님이 들어왔습니다. if 'Leave', 마지막 닉네임님이 나갔습니다.
